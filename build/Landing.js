...
var _user$project$Landing$updateWithStorage = F2(
	function (msg, model) {
		var _p3 = A2(_user$project$Landing$update, msg, model);
		var newModel = _p3._0;
		var cmds = _p3._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$Landing$exampleModel = function () {
	...
	return {campaigns: exampleCampaigns, creating: false};
}();
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$class(
				model.creating ? 'md-modal md-show' : 'md-modal'),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('md-content'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Start a Campaign'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('This is where the form will go!'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('md-submit'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('md-cancel'),
												_1: {
													ctor: '::',
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('or, cancel'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Landing$campaignListItem = function (campaign) {
	var pinner = A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('camp-pin'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						A2(_user$project$Landing$SetPinned, campaign.name, true)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
		...
		if (_p4.ctor === 'DM') {
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Dungeon Master'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			};
			...
			return {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], _p4._0.name, ' ')),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(_p4._0.level)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	var info = {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(campaign.name),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
	...
	var children = (!campaign.pinned) ? {ctor: '::', _0: pinner, _1: info} : info;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('list-item campaign'),
			_1: {ctor: '[]'}
		},
		children);
};
var _user$project$Landing$pinnedListItem = function (campaign) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('list-item pinned-campaign'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('pinned-unpin'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								A2(_user$project$Landing$SetPinned, campaign.name, false)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
				...
				_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(campaign.players),
											' players')),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('last-played'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'Last played: ',
												_user$project$Landing$dateStringHelper(campaign.lastPlayed))),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('playing-for'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
										...
										{ctor: '[]'},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'Playing since: ',
													_user$project$Landing$dateStringHelper(campaign.startDate))),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('pinned-buttons'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Session Log'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('pinned-container'),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Pinned Campaigns'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							A2(
								_elm_lang$core$List$map,
								_user$project$Landing$pinnedListItem,
								A2(
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('all-container'),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('All Campaigns'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									A2(_elm_lang$core$List$map, _user$project$Landing$campaignListItem, model.campaigns),
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('create-campaign-button'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
				...
				_1: {
					ctor: '::',
					_0: _user$project$Landing$creationDialog(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('md-overlay'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
																		...
																		return A2(
																			...
																			function (players) {
																				return A2(
																					...
																					function (startDate) {
																						return _elm_lang$core$Json_Decode$succeed(
																							{character: character, dm: dm, lastPlayed: lastPlayed, name: name, pinned: pinned, players: players, startDate: startDate});
																					},
																					A2(_elm_lang$core$Json_Decode$field, 'startDate', _elm_lang$core$Json_Decode$float));
																			},
																			A2(_elm_lang$core$Json_Decode$field, 'players', _elm_lang$core$Json_Decode$int));
																	},
																	A2(_elm_lang$core$Json_Decode$field, 'pinned', _elm_lang$core$Json_Decode$bool));
															},
															A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
													},
													A2(_elm_lang$core$Json_Decode$field, 'lastPlayed', _elm_lang$core$Json_Decode$float));
											},
											A2(_elm_lang$core$Json_Decode$field, 'dm', _elm_lang$core$Json_Decode$bool));
									},
									A2(
										_elm_lang$core$Json_Decode$field,
										'character',
